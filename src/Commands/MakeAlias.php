...
class MakeAlias extends BaseCommand
{
    public function configure()
    {
        $this->setName('make:alias')
            ...
            ->addOption('server', null, InputOption::VALUE_REQUIRED, 'The id of the server you want to alias.')
            ->addOption('site', null, InputOption::VALUE_REQUIRED, 'The id of the site you want to alias. May be left empty.')
